  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col px-4 pb-28 pt-4">
      ...
      <div className="flex items-center justify-between gap-2">
        <h1 className="font-display text-2xl font-bold tracking-tight">Karte</h1>
        <button
          type="button"
      ...
      <div className="mt-3 min-h-[calc(100dvh-9rem)] flex-1">
        <ChargeMap stations={stations} center={center} zoom={10} height="calc(100dvh - 9rem)" />
      </div>
