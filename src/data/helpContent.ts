...
export const helpFaqs: HelpFaq[] = [
  ...
  },
  {
    ...
    answer: {
      de: 'Nein. BC Charge erhebt keine Blockier- oder Standgebühren, wenn das Fahrzeug nach dem Laden noch angesteckt bleibt. Abgerechnet wird die geladene Energie (und nur Komponenten, die im vor dem Start sichtbaren Tarif ausdrücklich ausgewiesen sind – z. B. Energiepreis).',
      en: 'No. BC Charge does not charge idle or blocking fees if the vehicle stays plugged in after charging. You pay for the energy delivered (and only components explicitly shown in the tariff before you start — e.g. energy price).',
    },
  },
  {
    id: 'bc-points',
